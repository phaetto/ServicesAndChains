namespace Services.Management.Administration.Update
{
    ...
    public sealed class WaitUntilServiceIsUp : IChainableAction<ClientConnectionContext, ClientConnectionContext>,
        IAuthorizableAction,
        IApplicationAuthorizableAction
    {
        ...
        public WaitUntilServiceIsUp(string serviceId, int waitDelayInMilliseconds = 5000)
        {
